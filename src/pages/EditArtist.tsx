...
export default function EditArtist() {
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: typeof formData) => {
      const response = await authenticatedFetch(`${import.meta.env.VITE_API_BASE || ''}/api/artist-profile/me`, {
        method: 'PUT',
        headers: {
      ...
      if (!response.ok) {
        ...
        throw new Error(error.message || error.error || 'Failed to update artist');
      }
