...
export function CollabRequestCard({ request, mode }: CollabRequestCardProps) {
  const [showRespondDialog, setShowRespondDialog] = useState(false);
  const [responseType, setResponseType] = useState<'approved' | 'rejected' | 'completed'>('approved');
  ...
  const openRespondDialog = (type: 'approved' | 'rejected' | 'completed') => {
  ...
  return (
    <>
      <Card>
        ...
        {/* Action Buttons */}
        {mode === 'artist' && request.status === 'pending' && (
        ...
        {mode === 'artist' && request.status === 'approved' && (
          <CardFooter>
            <Button 
              variant="outline" 
              className="w-full"
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {responseType === 'completed' && 'Confirm that this collaboration has been completed'}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="response">
                Your Message {responseType !== 'completed' && '(Optional)'}
              </Label>
              <Textarea
                id="response"
                placeholder={
                  responseType === 'approved'
                    ...
                    : 'Add any final notes about the collaboration...'
                }
