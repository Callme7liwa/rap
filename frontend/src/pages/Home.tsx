    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 border border-primary text-primary uppercase tracking-widest text-xs mb-6">
              <Sparkles className="w-4 h-4 text-primary" />
              <span className="font-heading">Your Ultimate Music & Lyrics Destination</span>
            </div>
            
            <h1
              className="mb-6 font-display text-8xl md:text-[12rem] leading-none uppercase glitch"
              data-text="LYRICSCAPE"
            >
              LYRICSCAPE
            </h1>
            
            <p className="font-heading text-xl uppercase tracking-widest text-muted-foreground mb-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link to="/artists">
                <Button size="lg" className="gap-2 bg-primary text-primary-foreground uppercase font-heading tracking-wider rounded-none px-8 py-3 hover:shadow-hard transition-shadow">
