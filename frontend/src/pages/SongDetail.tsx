  ...
  const { 
    ...
    queryFn: async () => {
      ...
      const [artist, album] = await Promise.all([
        song?.primary_artist_id ? getArtistById(song.primary_artist_id) : Promise.resolve(null),
        song?.album_id ? getAlbumById(song.album_id) : Promise.resolve(null),
      ]);
      return { song, artist, album, comments: [] };
    },
    enabled: !!songId,
  });
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="glass rounded-none p-6 flex items-center justify-between">
              <div>
