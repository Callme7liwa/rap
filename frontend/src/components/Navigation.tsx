...
import { Music, Users, Disc, ListMusic, Wand2, Search, Moon, Sun, Vote, BookOpen, LogIn, LogOut, User, Upload, Activity, Handshake, Bell } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            ...
            <span className="font-display text-2xl tracking-wider text-primary">LYRIC_SCAPE</span>
          </Link>
              ...
              return (
                <Link key={item.to} to={item.to}>
                  <Button
                    ...
                    size="sm"
                    className="gap-2 uppercase tracking-widest text-xs font-heading"
                  >
