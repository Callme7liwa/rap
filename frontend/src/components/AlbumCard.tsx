...
export function AlbumCard({ album, index = 0 }: AlbumCardProps) {
  ...
  const coverArtUrl = album.cover_art_url || '/placeholder.svg';
  const releaseLabel =
    album.release_date_for_display || album.release_date || 'Unknown';
      ...
      >
        ...
        <div className="p-4">
          <div className="flex items-center justify-between gap-2 mb-1">
            <h3 className="font-heading font-semibold uppercase tracking-wide text-lg truncate group-hover:text-primary transition-colors flex-1">
              {album.name}
            </h3>
            {isOwned && (
